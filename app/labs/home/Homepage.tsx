...
function Homepage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center pt-[5rem] gap-10">
      <div className="grid tablet:w-[85%] xsPhone:w-full laptop:grid-cols-2 tablet:grid-cols-2 xsPhone:grid-cols-2 grid-rows-auto gap-6 tablet:px-10 xsPhone:px-6">
